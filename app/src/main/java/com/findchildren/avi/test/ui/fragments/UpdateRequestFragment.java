...
public class UpdateRequestFragment extends Fragment implements View.OnClickListener {
...
//        long id = getArguments().getLong(Const.CURRENT_USER_ID);
    ...
    public void onStart() {
        super.onStart();
        if(request!=null){
            mTextname.setText(request.getName());
            mTextBirth.setText(request.getDateOfBirth());
            mTextRegion.setText(request.getRegion());
            mSituationDescription.setText(request.getSituationDescription());
            mChildDescription.setText(request.getChildDescription());
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.frg_request_txt_time_od_loss:
                ...
                break;
//            case R.id.frg_request_txt_to_time_od_loss:
